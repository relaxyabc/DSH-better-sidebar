...
export const zh = {
  ...
  settingsSkillsTitle: 'Skill 清单',
  settingsSkillModelOn: '模型可调用',
  settingsSkillModelOff: '模型不可调用',
  settingsSkillUserOn: '用户可调用',
  settingsSkillUserOff: '用户不可调用',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsSkillModelOn: 'Model-callable',
  settingsSkillModelOff: 'Not model-callable',
  settingsSkillUserOn: 'User-callable',
  settingsSkillUserOff: 'Not user-callable',
