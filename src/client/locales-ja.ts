...
export const ja: Record<string, string> = {
  ...
  settingsMcpTitle: 'MCP サーバー',
  settingsSkillsTitle: 'スキル',
  settingsSkillModelOn: 'モデル呼出可能',
  settingsSkillModelOff: 'モデル呼出不可',
  settingsSkillUserOn: 'ユーザー呼出可能',
  settingsSkillUserOff: 'ユーザー呼出不可',
